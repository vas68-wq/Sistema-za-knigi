...
def index():
    ...
    # КОРЕКЦИЯ: Вземаме данните за модалните прозорци
...
def public_catalog_page():
    ...
    return render_template('public_catalog.html', genres=genres, latest_books=latest_books, popular_books=popular_books)
